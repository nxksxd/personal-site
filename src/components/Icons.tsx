...
export function VKIcon({ size = 22 }: { size?: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="currentColor">
      <path d="M13.162 18.994c-5.096 0-8.002-3.494-8.123-9.31h2.554c.084 4.269 1.968 6.078 3.46 6.451V9.684h2.406v3.681c1.473-.158 3.02-1.834 3.542-3.681h2.405c-.401 2.276-2.076 3.952-3.266 4.641 1.19.559 3.098 2.02 3.822 4.669h-2.648c-.567-1.764-1.98-3.13-3.855-3.316v3.316h-.29z" />
    </svg>
  );
}
...
export function WebsiteIcon({ size = 22 }: { size?: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
